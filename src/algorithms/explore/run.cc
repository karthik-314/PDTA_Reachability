             ...
             tchecker::log_t & log, bool eqOrSim)
    {
      switch (options.search_order()) {
        case tchecker::explore::options_t::BFS:
          tchecker::explore::details::run<tchecker::fifo_waiting_t>(sysdecl, options, log, eqOrSim);
          break;
        case tchecker::explore::options_t::DFS:
          tchecker::explore::details::run<tchecker::lifo_waiting_t>(sysdecl, options, log, eqOrSim);
          break;
        default:
