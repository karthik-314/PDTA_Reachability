...
#define DBM2(i,j)         dbm2[(i)*dim+(j)]
    ...
    {
    	// std::cout << "universal_positive was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
      for (tchecker::clock_id_t i = 0; i < dim; ++i)
        for (tchecker::clock_id_t j = 0; j < dim; ++j)
    ...
    {
    	// std::cout << "is_consistent was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
      for (tchecker::clock_id_t i = 0; i < dim; ++i)
    ...
    {
    	// std::cout << "is_universal was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
    ...
    {
    	// std::cout << "is_universal_positive was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
    ...
    {
    	// std::cout << "reset_to_value was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
      assert(tchecker::dbm::is_consistent(dbm, dim));
      assert(tchecker::dbm::is_tight(dbm, dim));
    ...
    {
    	// std::cout << "reset_to_clock was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
      assert(tchecker::dbm::is_consistent(dbm, dim));
      assert(tchecker::dbm::is_tight(dbm, dim));
    ...
    void reset_to_sum(tchecker::dbm::db_t * dbm, tchecker::clock_id_t dim, tchecker::clock_id_t x,
                      tchecker::clock_id_t y, tchecker::integer_t value)
    {
    	// std::cout << "reset_to_sum was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
      assert(tchecker::dbm::is_consistent(dbm, dim));
      assert(tchecker::dbm::is_tight(dbm, dim));
    ...
    {
    	// std::cout << "intersection was used\n";
      assert(dim >= 1);
      assert(dbm != nullptr);
      assert(dbm1 != nullptr);
      assert(dbm2 != nullptr);
    ...
    {
    	// std::cout << "extra_m_plus was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
      assert(tchecker::dbm::is_consistent(dbm, dim));
      assert(tchecker::dbm::is_positive(dbm, dim));
    ...
    void extra_lu_plus(tchecker::dbm::db_t * dbm, tchecker::clock_id_t dim, tchecker::integer_t const * l,
                       tchecker::integer_t const * u)
    {
    	std::cout << "extra_lu_plus was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
      assert(tchecker::dbm::is_consistent(dbm, dim));
      assert(tchecker::dbm::is_positive(dbm, dim));
    ...
    bool my_lu_plus(tchecker::dbm::db_t *db1, tchecker::dbm::db_t *db2, tchecker::clock_id_t dim1, tchecker::clock_id_t dim2, tchecker::integer_t const * l, tchecker::integer_t const * u, bool subsumption){
      if(subsumption) return !is_alu_le(db2, db1, dim1, l, u);
      else  return !(is_alu_le(db1, db2, dim1, l, u) && is_alu_le(db2, db1, dim1, l, u));
    }
    ...
    {
    	// std::cout << "output_matrix was used\n";
      assert(dbm != nullptr);
      assert(dim >= 1);
