...
namespace tchecker {
  ...
  namespace dbm {
    ...
    public:
      ...
      /*!
        \brief Determine if a DBM is simulated by/equivalent to another.
        \param db1: DBM of Z1
        \param db2: DBM of Z2
        \param dim1: Dimension of db1
        \param dim2: Dimension of db2
        ...
        \return For equivalence return false if Z1~Z2, else return true. For subsumption return
        false if Z2<=Z1, else return true.
      */
      bool equal(tchecker::dbm::db_t *db1, tchecker::dbm::db_t * db2, tchecker::clock_id_t dim1, tchecker::clock_id_t dim2, bool subsumption);

      /*!
        \brief Determine if a DBM is equal to another.
        \param db1: First DBM
        \param db2: Second DBM
        \param dim1: Dimension of db1
        \param dim2: Dimension of db2
        \return If DBMs are exactly the same return true, else return false.
      */
      bool exact_equal(tchecker::dbm::db_t *db1, tchecker::dbm::db_t * db2, tchecker::clock_id_t dim1, tchecker::clock_id_t dim2);
    };
    ...
    public:
      ...
      */
      inline bool equal(tchecker::dbm::db_t *db1, tchecker::dbm::db_t * db2, tchecker::clock_id_t dim1, tchecker::clock_id_t dim2, bool subsumption){
        return 1;
      }
      /*!
        \brief Placeholder, to be implemented later.
      */
      inline bool exact_equal(tchecker::dbm::db_t *db1, tchecker::dbm::db_t * db2, tchecker::clock_id_t dim1, tchecker::clock_id_t dim2){
        return 1;
      }
    ...
    public:
      ...
      /*!
        ...
        \return For equivalence return false if Z1~Z2, else return true. For subsumption return
        false if Z2<=Z1, else return true.
        Go to dbm/dbm.hh for more details.
      */
      inline bool equal(tchecker::dbm::db_t *db1, tchecker::dbm::db_t * db2, tchecker::clock_id_t dim1, tchecker::clock_id_t dim2, bool subsumption){
        return tchecker::dbm::my_lu_plus(db1, db2, dim1, dim2, _L, _U, subsumption);
      }
      ...
      */
      inline bool exact_equal(tchecker::dbm::db_t *db1, tchecker::dbm::db_t * db2, tchecker::clock_id_t dim1, tchecker::clock_id_t dim2){
        return tchecker::dbm::is_equal(db1, db2, dim1);
      }
