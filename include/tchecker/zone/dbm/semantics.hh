  ...
  namespace dbm {
    ...
    public:
      ...
      /*!
        ...
        Go To zone/dbm/extrapolation.hh for more details.
      */
      bool equal(tchecker::dbm::zone_t & z1, tchecker::dbm::zone_t & z2, bool subsumption){
        tchecker::dbm::db_t * db1 = z1.dbm();
        auto dim1 = z1.dim();
        tchecker::dbm::db_t * db2 = z2.dbm();
        auto dim2 = z2.dim();
        return EXTRAPOLATION::equal(db1, db2, dim1, dim2, subsumption);
      }
      ...
      /*!
        ...
        Go To zone/dbm/extrapolation.hh for more details.
      */
      bool exact_equal(tchecker::dbm::zone_t & z1, tchecker::dbm::zone_t & z2){
        tchecker::dbm::db_t * db1 = z1.dbm();
        auto dim1 = z1.dim();
        tchecker::dbm::db_t * db2 = z2.dbm();
        auto dim2 = z2.dim();
        return EXTRAPOLATION::exact_equal(db1, db2, dim1, dim2);
      }
    ...
    public:
      ...
      /*!
        \brief Simple placeholder, need to implemented for non-elapsed later.
      */
      bool equal(tchecker::dbm::zone_t & z1, tchecker::dbm::zone_t & z2, bool subsumption){
        return 1;
      }
